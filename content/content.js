eloquent_ruby = {
    image = "../images/cover-eloquent-ruby",
    Book: "Eloquent Ruby",
    Author: "Russ Olsen",
    ...
    publication_date: "February 21st 2011",
    ...
    reviews: {
        1: {
            ...
            "Review #1": `This book is so easy to read yet so useful and informative that I read it in its entirety within 24 hours (across 2 distinct days admittedly ;-)).
        ...
        2: {
            ...
            "Review #2": `For better or worse the vast majority of my work life journey has been travelled with Java as my vehicle of expression. However, by nature I have a burning desire to learn new languages and at one point or another I discovered Russ Olsen's (also the author of Eloquent Ruby) "Design Patterns in Ruby". Having at one time counted myself as a true-believer in everything pattern-esque, I was excited for the opportunity to learn Ruby under the aegis of The Gang of Four. However, what I found was something else entirely. I absolutely loved "Design Patterns in Ruby" for reasons that I was not expecting. That is, what I found was an extremely interesting book that was playful and as a nice side-effect *actually taught me how Ruby's powerful features make many design patterns unnecessary*.
...
window.addEventListener("DOMContentLoaded", function(){
    displayBookInfo(eloquent_ruby);
});

function displayBookInfo(book){
    let displayBook = book.map( function (elem){
        return 
        `
        <article class = "book-info" onclick = "location.href='${elem.website}'">
            <img src = ${elem.image} alt = ${elem.book} class = "photo />
            <div class = "book-info">
            <p> hi </p>
            </div>
